...
<head>
    ...
    <link rel="stylesheet" href="../css/formcoordarnador.css"> <!-- Adicione o link para o CSS -->
...
$(document).ready(function() {
    // Adicionar conteúdo padrão para visualização de CSS
    ...
    // Preencher conteúdo simulado ao carregar a página
